...
function createComment (url, request) {
  ...
  // response 200 if body, user, article id exist; response 400 if not
  if (requestComment && requestComment.comment && requestComment.comment.body && database.users[requestComment.comment.username] &&
...
function updateComment (url, request) {
  ...
  // if comment with given id doesn't exist: 404, no id or updated comment: 200, otherwise 200 and and updated comments
